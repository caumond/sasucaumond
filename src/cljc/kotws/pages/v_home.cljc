...
(defn v-home
  ...
  (let [tr (partial klang/tr dic l)
        w "10em"]
    [:div [:h1 (tr :home-msg)] [:p.text (tr :home-intro)] [:hr]
     (-> [:div.w3-cell-row]
...
;;        :download {:fr "Télécharger ce document", :en "Download that
;;        document"},
...
;;     [:i.fa.fa-download.w3-margin.w3-right]] [:h1 (tr :title)] [:p (tr
;;     :intro)]
;;    [:p (tr :intro2)] [:div]])
...
;;                   :details
;;                     "A PLM is a product lifecycle management tool, providing
;;                     a product, bill of materials and routings
;;                     referential."},
;;                :fr
;;                  {:text "Construction d'un PLM (Product Lifecycle
;;                  Management)",
;;                   :details
;;                     "Un PLM est un outil de gestion du cycle de vie du
;;                     produit, permettant de créer un référentiel de produits,
;;                     gammes et nomenclatures."}}}
;;            {:ml
;;               {:en
;;                  {:text "Creation, selling and materialization the vision",
;;                   :details
;;                     "Starting in 2018, my first mission was to build the
;;                     vision in an Entreprise Architecture study. Then, I
...
;;                  vision",
;;                   :details
;;                     "Commencée en 2018 dans une étude d'architecture
...
;;                    {:text "Team leader",
;;                     :details
;;                       "Management d'une équipe d'une dizaine de
;;                       personnes"}}}]}
;;        {:icon "fa-code",
;;         :items
...
;;                   :details
;;                     "Development in clojure. Data mapping in huge maps
;;                     (specter), describe a model with data samples and schema
;;                     validation with malli."},
;;                :fr
;;                  {:text "Prototypage en clojure",
;;                   :details
;;                     "Développement en clojure. Mapping de données dans de
;;                     grandes `map` (specter), description de modèle en
;;                     illustrant par des données et en validant ces schémas en
;;                     malli."}}}
;;            {:ml
;;               {:en
;;                  {:text "Application design ",
;;                   :details
;;                     "Design some complex concepts around release management
;;                     and change orders."},
;;                :fr
...
;;     :date "2019",
;;     :where-link "https://www.michelin.fr/",
;;     :ml {:en {:title "Supply Chain Entreprise Architect", :where
;;     "Michelin"},
...
;;                   :details
;;                     "Some studies to illustrate this activity: Offtakers
;;                     integration in group process, taking group strategy,
;;                     fiscality, customs and logistics into account. Study on
;;                     OPE transformation program next step on finished product
;;                     plants."},
;;                :fr
...
;;                   :details
;;                     "I was in charge of supply chain software package
;;                     purchase: a first project on an automative ERP for
;;                     integration with automotive customers and their
;;                     specificities. A second project to equip a subsidiary
;;                     with an integrated supply chain tool."},
;;                :fr
;;                  {:text "Achat de progiciels entreprises",
;;                   :details
;;                     "J'ai eu en charge l'achat des progiciels de mon domaine
;;                     supply chain: un premier projet sur un ERP spécialisé
;;                     dans l'automobile pour intégration avec les clients
;;                     automobiles et leurs spécificités. Un second projet pour
;;                     outiller une filiale avec un outil de supply chain
;;                     intégré."}}}
;;            {:public-reference
...
;;                     metiers, supervise projects execution."},
;;                :fr
;;                  {:text "Etudes cadres d'un programme de transformation
;;                  majeur",
;;                   :details
;;                     "Participant à l'équipe d'architecture du programme OPE
;;                     (cf. le lien), nous avions en charge de trouver des
;;                     solutions (métiers et informatiques) quand elles font
;;                     évoluer plusieurs métiers et équipes. Les missions:
;;                     cadrer les interactions entre les métiers, superviser
;;                     l'exécution des projets."}}}
;;            {:public-reference
;;               "https://www.strategieslogistique.com/Michelin-ameliore-son-S-OP-avec",
;;             :ml
;;               {:en
;;                  {:text "Sales and Operations framework and sourcing with
;;                  JDA",
;;                   :details
;;                     "Finalize purchasing of software package with JDA, frame
;;                     the project"},
;;                :fr
;;                  {:text "Cadrage et achat d'un progiciel S&OP avec JDA",
;;                   :details
;;                     "Finalisation de l'achat du progiciel S&OP avec JDA,
;;                     cadrage du projet."}}}
;;            {:ml
;;               {:en
;;                  {:text "First attempt of group A.I. software purchasing",
;;                   :details
;;                     "In a group which curiosity for A.I. is awaking, this
;;                     study has to formalize what is the need for software
;;                     package or in-house competency. The conclusion was to
;;                     develop in-house."},
;;                :fr
;;                  {:text
...
;;                   :details
;;                     "That position was an opportunity to meet main Supply
;;                     Chain software vendors: OMP, JDA, ORACLE, INFOR and
;;                     understand their offers."},
;;                :fr
;;                  {:text "Connaissance des principaux progiciels Supply
;;                  Chain",
;;                   :details
;;                     "Ce poste a été l'occasion de rencontrer régulièrement
;;                     les principaux vendeurs de logiciels Supply Chain: OMP,
;;                     JDA, ORACLE, INFOR et d'approfondir leurs offres."}}}
...
;;                   :details
;;                     "Livraison des livrables conformément au processus
;;                     Architecture Entreprise tel que décrit par TOGAF (cf.
;;                     certification). 200 logiciels dans mon périmètre et
;;                     quelques architectes dans mon réseau."}}}
;;            {:public-reference
...
;;                :fr
;;                  {:text
;;                     "Lancement d'une application de streaming d'événements -
;;                     le booster stock",
;;                   :details
...
;;                  {:text "Architecture business",
;;                   :details
;;                     "Au démarrage du programme OPE, les 60 sites de
...
;;                   :details
;;                     "Expert (solution consultant) of a master planning
;;                     application for finish products plant - deployment on
;;                     asian and south american plants."},
;;                :fr
...
;;                   :details
;;                     "I was certified with MGCM with a BASICS level of APICS.
;;                     Supply chain oriented, dealing with methods and tools,
;;                     this training gives a comprehensive panorama of supply
;;                     chain."},
;;                :fr
...
;;                     chain."}},
;;             :public-reference
;;             "https://www.fapics.org/762_p_44058/bscm.html"}]}
;;        {:icon "fa-code",
;;         :items
;;           [{:ml
;;               {:en
...
;;                   :details
;;                     "Solution architect of two planning solution -
;;                     architecture folder."},
;;                :fr
;;                  {:text "Architecte solution",
;;                   :details
;;                     "Architecte solution sur deux solutions de planification
...
;;                :fr
;;                  {:text
;;                     "Planning de distribution - DRP - gestion du
;;                     changement",
;;                   :details
;;                     "Conception de réseaux de distribution, de déploiement
;;                     d'un DRP sur 3 lignes de produits (Poids Lourd Europe,
;;                     Agro, Afrique Inde Moyen Orient)"}}}]}
;;        {:icon "fa-infinity",
;;         :items
;;           [{:ml
;;               {:en
...
;;                   :details
;;                     "Résolution de milliers (un par référence article) de
;;                     problème de flots minimum, grâce à l'algorithme de
;;                     busaker et gowen (coût de transport minimum respectant
;;                     les contraintes capacitaires)."}}}
;;            {:ml
;;               {:en
...
;;                   :details
;;                     "Vacataire en Master I et Master II en Logistique et
;;                     Supply Chain."}}}]}
;;        {:icon "fa-code",
;;         :items
;;           [{:ml
...
;;                  {:text "PLSQL",
;;                   :details
;;                     "Integration in PLSQL of optimization tool (Thousand of
;;                     product references calculation)."},
;;                :fr
;;                  {:text "PLSQL",
;;                   :details
;;                     "Conception, développement et intégration de la solution
...
;;                   :details
;;                     "Analyse du besoin - conception - développement d'un
;;                     outil d'optimisation des plans tactiques (make or
;;                     buy)."}}}]}]}
...
;;                     :details "Build and practise of an order to cash
;;                     process."},
;;                :fr
...
;;                  {:text "Php5 - mysql paradox db - Borland C++",
;;                   :details
;;                     "Le site web était opérationnel et fonctionnait pendant
...
;;                   :details
;;                     "PSA - Optimisation des lignes d'assemblage (conception
;;                     des postes) - PSA - Optimisation des chantiers
;;                     polyvalents (RCPSP)- Eramet - Optimisation des ateliers
;;                     de forge à chaud (Jobshop with time lags) - Michelin -
;;                     Gestion d'emploi du temps des pistes d'essais (Time
;;                     tabling problem) - Michelin - Simulation et optimisation
;;                     des usines (Simulation à événements discrets et
;;                     heuristiques)."}}}]}
;;        {:icon "fa-code",
;;         :items
;;           [{:ml
...
;;                   :details
;;                     "Most of that poc are assorted with user interfaces for
;;                     data preparation, result visualization, setup and
;;                     optimisation monitoring."},
;;                :fr
;;                  {:text "Interfaces utilisateurs et backend en Borland C++",
;;                   :details
;;                     "Ces démonstrateurs sont pour la plupart agrémentés
;;                     d'interfaces utilisateurs pour la préparation des
;;                     données, la visualisation des résultats, le paramétrage
;;                     et pour le suivi de l'optimisation."}}}
;;            {:ml
;;               {:en
;;                  {:text "C++ Framework for iterative optimization",
;;                   :details
;;                     "The chapter 5 of my thesis offers a framework for
;;                     iterative optimization."},
;;                :fr
;;                  {:text "Cadriciel pour l'optimisation itérative",
;;                   :details
;;                     "Le chapitre 5 de ma thèse propose un framework pour
;;                     l'optimisation itérative."}}}]}
;;        {:icon "fa-infinity",
;;         :items
;;           [{:download
;;           "https://tel.archives-ouvertes.fr/tel-00713587/document",
;;             :ml
;;               {:en
;;                  {:text "Phd thesis",
;;                   :details
...
;;                  {:text "Thèse",
;;                   :details
;;                     "Le titre de ma thèse est `Le problème de jobshop avec
;;                     contraintes: modélisation et optimisation`. Dans son
...
;;                  {:text "Articles",
;;                   :details
;;                     "Various articles are presented in conferences and
;;                     journals."},
;;                :fr
;;                  {:text "Articles",
;;                   :details
;;                     "Plusieurs articles issus de conférences et de
;;                     journaux."}}}
;;            {:public-reference
...
;;                  {:text "C.O.R. - Timelag",
;;                   :details
;;                     "The time lag constraints allow to manage minimum and
;;                     maximum heating time, between forge operations. That
;;                     constraints turn one machine problems into NP-complete
;;                     problems. That article use a genetic algorithm to find
;;                     optimized solutions for practical problems."},
;;                :fr
;;                  {:text "C.O.R. - Timelag",
;;                   :details
...
;;                   :details
;;                     "Cet article présente un modèle mathématique démontrant
;;                     l'importance de la contrainte de non anticipation."}}}
;;            {:ml
;;               {:en
;;                  {:text "Iterative methods",
;;                   :details
;;                     "Iterative methods, integer linear programming, graph
;;                     optimization"},
;;                :fr
;;                  {:text "Méthodes itératives",
;;                   :details
;;                     "Méthodes itératives, programmation linéaire en nombres
;;                     entierss, optimisation de graphe"}}}]}]}
;;    {:icon "fa-school",
...
;;               {:en
;;                  {:text
;;                     "Simulation, modelling and optimization of industrial
;;                     systems",
;;                   :details
;;                     "Complex systems simulation, production and operations
;;                     research with markov chains, Constraint Programming,
;;                     Heuristics for production systems, Modelling and
...
;;                  {:text "Démos et jeux",
;;                   :details
;;                     "J'ai découvert le développement en créant des jeux, en
;;                     mode texte (en redéfinissant les caractères) ou en mode
;;                     graphique. Mais j'ai passé beaucoup de temps à faire des
;;                     démos: des vectors balls, des rasters, des overscans, de
;;                     la 3D en wireframe, en redécouvrant les algorithmes de
;;                     traçage de lignes."}}}
;;            {:ml
;;               {:en
...
;;                   :details
;;                     "A une époque où les logiciels de gestion professionnels
;;                     étaient rares, j'ai eu l'occasion de construire le
;;                     logiciel de gestion de stock de la bijouterie familiale
;;                     en gfa basic. "}}}
;;            {:ml
;;               {:en
;;                  {:text "GFA basic & 68000 assembly",
;;                   :details
;;                     "I used mainly that two languages for the above
;;                     achievements. I also had the opportunity to use Z80 and
;;                     code machine."},
;;                :fr
