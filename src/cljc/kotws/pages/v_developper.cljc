...
(def dic
  {:computer-science {:fr "Informatique", :en "Computer science"},
   ...
   :design {:en "Industrial configuration management",
            :fr "Gestion de configuration industrielle"},
   :design-desc {:fr "Conception d'un PLM pour l'industrie",
    ...
    [(c [l]
       (->
         [[:hephaistox
          ...
          [:storrito
           {:img-url "images/storrito.png", :href "http://www.storrito.com"}]
          [:design
          ...
          [:initial
           {:href "https://www.isima.fr/", :img-url "images/isima.png"}]
          [:jewelry {:img-url "images/jewelry.png"}]
          [:demo-making
           {:img-url "images/demo_making.png",
            :href "https://en.wikipedia.org/wiki/Demoscene"}]
          [:coding-for-fun
           {:img-url "images/Z80.png",
